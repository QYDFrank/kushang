...
<html lang="en">
    ...
    <body>
        ...
        <div style="margin:80px 50px 5px 50px;">
					...
					<c:forEach var="product" items="${listProduct}">
						<tr style="font-size: 18px;height:36px;">
					        ...
					        <c:if test="${product.flag==1}">
								<td><a href="blockProduct?id=${product.id}" style="color:green;">Block</a></td>
							</c:if>
							<c:if test="${product.flag==2}">
								<td><a href="activeProduct?id=${product.id}" style="color:green;">Active</a></td>
							</c:if>
						</tr>
			       		<%srno++;%>
					</c:forEach>
	...
	<div style="margin-left: 1150px;margin-bottom: 20px;">
		<a href="addProduct" style="color:red;font-size: 20px;">New Product</a>
	</div>
